...
export const WORKFLOW_STEP_METADATA: Record<VizStep, WorkflowStepMetadata> = {
  ...
  1: {
    ...
    cfgSubtitle: 'Тежине грана се додељују према Кнутовом алгоритму (број путања до излаза) како би следећи кораци пратили структуру путања кроз CFG.',
    examplesSubtitle: 'Кнутове тежине истичу структурни значај грана и припремају граф за MST и селективну инструментацију.',
